...
namespace MyAPI.src.Model.Entities.User
{
    public class UserInputModel
    {
        ...
        [Required]
        [StringLength(100, MinimumLength = 3, ErrorMessage = "The last name must have between 3 and 100 characteres.")]
        ...
        [Required]
        [EmailAddress]
        [Remote(controller: "User", action: "IsEmailInUse", ErrorMessage = "Email Already Registered!")]
